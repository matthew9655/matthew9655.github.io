const texts = {
    ...
    // Modiface
    "about23": ".",
    "about31": " These days, I am interested in AI safety, LLM Compression and ML Ops. In my spare time, I enjoy skiing in the winter and taking really long walks in the summer. ",
